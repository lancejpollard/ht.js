export class TextureHelper {
  ...
  ///  </summary>
  get ElementIndices(): List<number[]> {}
  set ElementIndices(value: List<number[]>) {}
  ...
  static #CalcPointsUsingTwoSegments(
    ...
    let s1: Vector3D[] = TextureHelper.SubdivideSegmentInGeometry(
      seg1.P1,
      seg1.P2,
      divisions,
      g,
    )
    let s2: Vector3D[] = TextureHelper.SubdivideSegmentInGeometry(
      seg2.P2,
      seg2.P1,
      divisions,
      g,
  ...
  static #FindClosestPoint(v: Vector3D, list: Vector3D[]): Vector3D {
  ...
  static SubdivideSegmentInGeometry(
    ...
    let temp: Vector3D[] = TextureHelper.SubdivideRadialInGeometry(
      radial,
      divisions,
      g,
    )
  ...
  static ElementGraph(
    ...
    let result: Record<number, number[]> = new Record<
      number,
      number[]
    >()
    //  Brute force.
    let textureElements: number[] = TextureHelper.TextureElements(
      numBaseTriangles,
      LOD,
    )
