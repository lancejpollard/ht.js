...
module R3.UI {
    ...
    export class TrackBarValueEditor extends UITypeEditor {
        ...
        private editorService: IWindowsFormsEditorService = null;
        
        valueLow: number;
        
        valueHigh: number;
        
        public /* override */ EditValue(context: ITypeDescriptorContext, provider: IServiceProvider, value: Object): Object {
            if (((context != null) 
                        && (provider != null))) {
        ...
        public /* override */ GetEditStyle(context: ITypeDescriptorContext): UITypeEditorEditStyle {
            if (((context != null) 
        ...
        private ValueChanged(sender: Object, e: EventArgs) {
            //  I couldn't figure out how to update the text here, but that would be nice.
        }
        
        private MouseLeave(sender: Object, e: System.EventArgs) {
            if ((this.editorService != null)) {
