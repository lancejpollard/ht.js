...
module R3.Control {
    ...
    export class RotationHandler4D {
        ...
        public constructor (initialMatrix: Matrix4D) {
            Current4dView = initialMatrix;
        }
        
        private ViewMat4d: Matrix4D = Matrix4D.Identity();
        
        ///  <summary>
        ///  The current viewpoint.
        ///  </summary>
        public get Current4dView(): Matrix4D {
            return this.ViewMat4d;
        }
        public set Current4dView(value: Matrix4D)  {
            if ((value == null)) {
        ...
        ///  </summary>
        public MouseDragged(dx: number, dy: number, xz_yz: boolean, xw_yw: boolean, xy_zw: boolean) {
        ...
        private ApplySpinDelta(spinDelta: Matrix4D) {
