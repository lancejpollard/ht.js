...
module R3.Core {
    ...
    export class VEF {
        ...
        ///  The vertices.
        ///  </summary>
        public get Vertices(): GoldenVector4D[] {
        }
        public set Vertices(value: GoldenVector4D[])  {
        }
        ...
        public set Edges(value: GraphEdge[])  {
        }
        ...
        public Load(fileName: string) {
            let lines: IEnumerator<string> = File.ReadLines(fileName).GetEnumerator();
            lines.MoveNext();
