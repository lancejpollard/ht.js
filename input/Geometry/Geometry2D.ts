...
module R3.Geometry {
    ...
    export class PlatonicSolids {
        ...
        public static NumFacets(p: number, q: number): number {
            if (((p == 3)
                        && (q == 3))) {
                return 4;
            }
    ...
    export class Geometry2D {
        ...
        public static GetGeometry(p: number, q: number): Geometry {
        ...
        public static EuclideanHypotenuse: number = (1 / 3);

        //  ZZZ - ??????????
        public static DiskRadius: number = 1;

        public static GetNormalizedCircumRadius(p: number, q: number): number {
        ...
        ///  </summary>
        public static GetTriangleHypotenuse(p: number, q: number): number {
        ...
        ///  In the induced geometry.
        ///  </summary>
        public static GetTrianglePSide(p: number, q: number): number {
            let g: Geometry = Geometry2D.GetGeometry(p, q);
            let alpha: number = (Math.PI / 2);
            let beta: number = Geometry2D.PiOverNSafe(q);
            let gamma: number = Geometry2D.PiOverNSafe(p);
        ...
        ///  In the induced geometry.
        ///  </summary>
        public static GetTriangleQSide(p: number, q: number): number {
            let g: Geometry = Geometry2D.GetGeometry(p, q);
            let alpha: number = (Math.PI / 2);
            let beta: number = Geometry2D.PiOverNSafe(q);
            //  The one we want.
        ...
        ///  </summary>
        public static GetTriangleSide(g: Geometry, alpha: number, beta: number, gamma: number): number {
            switch (g) {
                case Geometry.Spherical:
                    //  Spherical law of cosines
                    return Math.Acos(((Math.Cos(alpha)
                ...
                case Geometry.Hyperbolic:
                    ...
                    return DonHatch.acosh(((Math.Cos(alpha)
                                    + (Math.Cos(beta) * Math.Cos(gamma)))
                                    / (Math.Sin(beta) * Math.Sin(gamma))));
                    break;
            }
