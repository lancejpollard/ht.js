...
module R3.Geometry {
    ...
    export class Tile {
        ...
        public constructor (boundary: Polygon, drawn: Polygon, geometry: Geometry) {
            Boundary = boundary;
            Drawn = drawn;
            Geometry = geometry;
        ...
        public set Boundary(value: Polygon)  {
        }

        public get Drawn(): Polygon {
        }
        public set Drawn(value: Polygon)  {
        }

        public get VertexCircle(): CircleNE {
        }
        public set VertexCircle(value: CircleNE)  {
        }
        ...
        ///           generation time.
        ///  </summary>
        public get Isometry(): Isometry {
        }
        public set Isometry(value: Isometry)  {
        }

        ///  <summary>
        ///  Used to track edge-adjacent tiles in a tiling.
        ///  </summary>
        public get EdgeIncidences(): List<Tile> {
        }
        public set EdgeIncidences(value: List<Tile>)  {
        }

        ///  <summary>
        ///  Used to track vertex-adjacent tiles in a tiling.
        ///  </summary>
        public get VertexIndicences(): List<Tile> {
        }
        public set VertexIndicences(value: List<Tile>)  {
        }
        ...
        ///  </summary>
        public get HasPointsProjectedToInfinity(): boolean {
        ...
        ///  </summary>
        public IncludeAfterMobius(m: Mobius): boolean {
        ...
        ///  </summary>
        private /* internal */ static ShrinkTileCorrect(/* ref */tile: Tile, shrinkFactor: number) {
            ...
            switch (tile.Geometry) {
                ...
                case this.Geometry.Spherical:
                    ...
                    let scale: number = Spherical2D.s2eNorm((Spherical2D.e2sNorm(v.Abs()) * s));
                    v.Normalize();
                    return (v * scale);
        ...
        ///  </summary>
        private /* internal */ static ShrinkTile(/* ref */tile: Tile, shrinkFactor: number) {
