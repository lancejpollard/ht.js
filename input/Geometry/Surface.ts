...
module R3.Geometry {
    ...
    export class Surface {
        ...
        ///  </summary>
        public static Dini(mesh: Mesh): Mesh {
        ...
        public static Dini(uv: Vector3D): Vector3D {
            return Surface.Dini2(uv);
        }

        private static Sech(val: number): number {
        ...
        ///  </summary>
        public static Dini2(disk: Vector3D): Vector3D {
        ...
        public static Dini(uv: Vector3D, a: number, b: number): Vector3D {
            ...
            let result: Vector3D = new Vector3D((pSinEta
                            * (Surface.Sech(chi) * Math.Cos((y / p)))), (pSinEta
                            * (Surface.Sech(chi) * Math.Sin((y / p)))), (x
                            - (pSinEta * Math.Tanh(chi))));
            return result;
        }

        private static DiskToUpper(input: Vector3D): Vector3D {
