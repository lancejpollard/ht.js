...
module R3.Math {
    ...
    export class Isometry extends ITransform {

        public constructor () {
            m_mobius.Unity();
        }

        public constructor (m: Mobius, r: Circle) {
            Mobius = m;
            Reflection = r;
        }

        public constructor (i: Isometry) {
            Mobius = i.Mobius;
        ...
        ///  </summary>
        @DataMember()
        public get Mobius(): Mobius {
            return m_mobius;
        }
        @DataMember()
        public set Mobius(value: Mobius)  {
            m_mobius = value;
        }

        private m_mobius: Mobius;
        ...
        ///  </summary>
        @DataMember()
        public get Reflection(): Circle {
            return m_reflection;
        }
        @DataMember()
        public set Reflection(value: Circle)  {
            m_reflection = value;
        ...
        private m_reflection: Circle;

        private m_cache1: Mobius;

        private m_cache2: Mobius;

        ///  <summary>
        ///  Composition operator.
        ///  </summary>>
        public static Operator(i1: Isometry, i2: Isometry): Isometry {
            ...
            if ((r1 | r2)) {
                result.Reflection = new Circle(Vector3D.FromComplex(w1), Vector3D.FromComplex(w2), Vector3D.FromComplex(w3));
        ...
        ///  </summary>
        private CacheCircleInversion(inversionCircle: Circle) {
            ...
            if (inversionCircle.IsLine) {
                ...
                p2 = (inversionCircle.Center + new Vector3D((inversionCircle.Radius * -1), 0));
        ...
        ///  </summary>
        private CacheCircleInversion(c1: Complex, c2: Complex, c3: Complex) {
            let toUnitCircle: Mobius = new Mobius();
            toUnitCircle.MapPoints(c1, c2, c3, new Complex(1, 0), new Complex(-1, 0), new Complex(0, 1));
            this.m_cache1 = toUnitCircle;
            this.m_cache2 = this.m_cache1.Inverse();
        }

        private ApplyCachedCircleInversion(input: Complex): Complex {
        ...
        private static IsNaN(c: Complex): boolean {
        ...
        ///  </summary>
        private CircleInversion(input: Complex): Complex {
        ...
        public static ReflectX(): Isometry {
            ...
            let reflection: Circle = new Circle(new Vector3D(), new Vector3D(1, 0));
        ...
        ///  </summary>
        public CalculateFromTwoPolygons(home: Tile, tile: Tile, g: Geometry) {
            let poly: Polygon = tile.Boundary;
            this.CalculateFromTwoPolygons(home, poly, g);
        }

        public CalculateFromTwoPolygons(home: Tile, boundaryPolygon: Polygon, g: Geometry) {
            this.CalculateFromTwoPolygonsInternal(home.Boundary, boundaryPolygon, home.VertexCircle, g);
        }

        private CalculateFromTwoPolygonsInternal(home: Polygon, boundary: Polygon, homeVertexCircle: CircleNE, g: Geometry) {
        ...
        ///  </summary>
        public static TransformVertices(vertices: Vector3D[], isometry: Isometry): Vector3D[] {
