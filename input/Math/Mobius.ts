...
module R3.Math {
    ...
    export struct Mobius extends ITransform {

        public constructor (a: Complex, b: Complex, c: Complex, d: Complex) {
            A = a;
            B = b;
            C = c;
            D = d;
        ...
        ///  </summary>
        public constructor (z1: Complex, z2: Complex, z3: Complex) {
            this.MapPoints(z1, z2, z3);
        }

        @DataMember()
        public get A(): Complex {
        }
        @DataMember()
        public set A(value: Complex)  {
        }

        @DataMember()
        public get B(): Complex {
        }
        @DataMember()
        public set B(value: Complex)  {
        }

        @DataMember()
        public get C(): Complex {
        }
        @DataMember()
        public set C(value: Complex)  {
        }

        @DataMember()
        public get D(): Complex {
        }
        @DataMember()
        public set D(value: Complex)  {
        }
        ...
        public static Operator(m1: Mobius, m2: Mobius): Mobius {
            let result: Mobius = new Mobius(((m1.A * m2.A)
                            + (m1.B * m2.C)), ((m1.A * m2.B)
                            + (m1.B * m2.D)), ((m1.C * m2.A)
                            + (m1.D * m2.C)), ((m1.C * m2.B)
                            + (m1.D * m2.D)));
        ...
        public Normalize() {
            ...
            let k: Complex = Complex.Reciprocal(Complex.Sqrt(((this.A * this.D)
                                - (this.B * this.C))));
            this.ScaleComponents(k);
        }

        public ScaleComponents(k: Complex) {
            this.A = (this.A * k);
            this.B = (this.B * k);
            this.C = (this.C * k);
            this.D = (this.D * k);
        ...
        public get Trace(): Complex {
            return (this.A + this.D);
        }

        public get TraceSquared(): Complex {
        ...
        ///  </summary>
        public Isometry(g: Geometry, angle: number, P: Complex) {
        ...
        public static CreateFromIsometry(g: Geometry, angle: number, P: Complex): Mobius {
        ...
        ///  </summary>
        public PureTranslation(g: Geometry, p1: Complex, p2: Complex) {
            let A: Complex = (p2 - p1);
            let B: Complex = (p2 * p1);
            let denom: number = (1
                        - ((this.B.Real * this.B.Real)
                        + (this.B.Imaginary * this.B.Imaginary)));
            let P: Complex = new Complex((((this.A.Real * (1 + this.B.Real))
                            + (this.A.Imaginary * this.B.Imaginary))
                            / denom), (((this.A.Imaginary * (1 - this.B.Real))
        ...
        ///  </summary>
        public Geodesic(g: Geometry, p1: Complex, p2: Complex) {
        ...
        public Hyperbolic(g: Geometry, fixedPlus: Complex, scale: number) {
            //  To the origin.
            let m1: Mobius = new Mobius();
        ...
        ///  </summary>
        public Hyperbolic2(g: Geometry, fixedPlus: Complex, point: Complex, offset: number) {
            //  To the origin.
            let m: Mobius = new Mobius();
        ...
        public Elliptic(g: Geometry, fixedPlus: Complex, angle: number) {
            //  To the origin.
        ...
        public UpperHalfPlane() {
            this.MapPoints((Complex.ImaginaryOne * -1), Complex.One, Complex.ImaginaryOne);
        }
        ...
        ///  </summary>
        public MapPoints(z1: Complex, z2: Complex, z3: Complex) {
            if (isInfinite(z1)) {
                this.A = 0;
                this.B = ((1
                            * (z2 - z3))
        ...
        ///  </summary>
        public MapPoints(z1: Complex, z2: Complex, z3: Complex, w1: Complex, w2: Complex, w3: Complex) {
            let m2: Mobius = new Mobius();
            let m1: Mobius = new Mobius();
        ...
        public Apply(z: Vector3D): Vector3D {
        ...
        ///  </summary>
        public Apply(z: Complex): Complex {
            return (((this.A * z)
                        + this.B)
                        / ((this.C * z)
                        + this.D));
        ...
        public ApplyInfiniteSafe(z: Vector3D): Vector3D {
            if (isInfinite(z)) {
        ...
        ///  </summary>
        public ApplyToQuaternion(q: Vector3D): Vector3D {
            if (isInfinite(q)) {
                return this.ApplyToInfinite();
            }
            ...
            return this.DivideQuat((this.MultQuat(a, q) + b), (this.MultQuat(c, q) + d));
        }

        private MultQuat(a: Vector3D, b: Vector3D): Vector3D {
        ...
        private DivideQuat(a: Vector3D, b: Vector3D): Vector3D {
            let magSquared: number = b.MagSquared();
            let bInv: Vector3D = new Vector3D((b.X / magSquared), ((b.Y / magSquared)
                            * -1), ((b.Z / magSquared)
                            * -1), ((b.W / magSquared)
                            * -1));
        ...
        public Inverse(): Mobius {
            ...
            let result: Mobius = new Mobius(this.D, (this.B * -1), (this.C * -1), this.A);
            result.Normalize();
            return result;
        }
        ...
        public static Scale(scale: number): Mobius {
        ...
        public Round(digits: number) {
            let d: number = digits;
            this.A = new Complex(Math.Round(this.A.Real, d), Math.Round(this.A.Imaginary, d));
            this.B = new Complex(Math.Round(this.B.Real, d), Math.Round(this.B.Imaginary, d));
            this.C = new Complex(Math.Round(this.C.Real, d), Math.Round(this.C.Imaginary, d));
            this.D = new Complex(Math.Round(this.D.Real, d), Math.Round(this.D.Imaginary, d));
        }
    }
}
