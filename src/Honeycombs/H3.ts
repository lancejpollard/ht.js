export class H3 {
  ...
  static GenH3CellFacets(tiling: Tiling): Array<H3Cell.H3CellFacet> {
  ...
  static #GenHoneycombInternal(
    ...
    let facets: Array<H3Cell.H3CellFacet> = H3.GenH3CellFacetSpheres(
      tiling,
      inRadius,
    )
...
export class H3Util {
  ...
  static AddToMeshInternal(
    ...
    if (m_settings.Halfspace) {
      let points: Array<Vector3D> = H3Models.UHS.GeodesicPoints(
        _v1,
        _v2,
      )
      if (!m_settings.ThinH3CellEdges) {
      ...
      div1 = 15
      div2 = 30
      let points: Array<Vector3D> = H3Models.Ball.GeodesicPoints(
        v1,
        v2,
        div1,
      )
