...
export class Honeycomb {
  static String(honeycomb: EHoneycomb, dual: boolean): string {
    switch (honeycomb) {
  ...
  static InRadius(honeycomb: EHoneycomb): number {
    let r: number
    let p: number
    let q: number
  ...
  static MidRadius(honeycomb: EHoneycomb): number {
    let r: number
    let p: number
    let q: number
    Honeycomb.PQR(honeycomb, /* out */ p, /* out */ q, /* out */ r)
  ...
  static CircumRadius(honeycomb: EHoneycomb): number {
    let r: number
    let p: number
    let q: number
    Honeycomb.PQR(honeycomb, /* out */ p, /* out */ q, /* out */ r)
  ...
  static EdgeLength(honeycomb: EHoneycomb): number {
    let r: number
    let p: number
    let q: number
    Honeycomb.PQR(honeycomb, /* out */ p, /* out */ q, /* out */ r)
  ...
  ///  </summary>
  static InRadius(p: number, q: number, r: number): number {
  ...
  ///  </summary>
  static CircumRadius(p: number, q: number, r: number): number {
    let pip: number = Honeycomb.PiOverNSafe(p)
  ...
  static EdgeLength(p: number, q: number, r: number): number {
    let pip: number = Honeycomb.PiOverNSafe(p)
    let pir: number = Honeycomb.PiOverNSafe(r)
    let pi_hqr: number = Honeycomb.Pi_hpq(q, r)
  ...
  static #Pi_hpq(p: number, q: number): number {
